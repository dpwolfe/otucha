...
namespace rffalcon
{
	...
	private:
		...
		void _addTextureGlyph(wchar_t charCode, GlyphData glyphData, ivec4 region, FT_Face face, FT_UInt glyphIndex);
		ivec4 _renderToAtlas(GlyphData glyphData, const wchar_t charCode, FT_Face face, FT_UInt glyphIndex);
